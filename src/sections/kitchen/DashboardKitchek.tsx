            ...
            <div>
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="sidenav-collapse-main">
                            ...
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="#">
                                        <i className="ni ni-pin-3 text-orange" />Menus
                                    </a>
                                </li>
                ...
                <div className="main-content">
                    <nav className="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                        <div className="container-fluid">
                            <a className="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Dashboard Welcome Kitchen</a>
                                            ...
                                            <div className="card-body">
                                                <div className="row">
                                                    <div className="col">
                                                        ...
                                                        <span className="h2 font-weight-bold mb-0">234</span>
                                                    </div>
                                                    <div className="col-auto">
                                ...
                                <div className="card shadow">
                                    <div className="card-header border-0">
                                        <div className="row align-items-center">
                                            <div className="col">
                                                <h3 className="mb-0">Recent Order Received</h3>
                                            </div>
